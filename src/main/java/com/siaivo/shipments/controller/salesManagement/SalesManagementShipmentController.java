...
@Controller
public class SalesManagementShipmentController {
...
//    }
    ...
    @RequestMapping(value="/salesManagement/allReleasedShipments", method = RequestMethod.GET)
    public ModelAndView allReleasedShipments(){
        ModelAndView modelAndView = getModelAndViewWithAllReleasedShipments();
        modelAndView.setViewName("/salesManagement/allReleasedShipments");
        return modelAndView;
    }

    @RequestMapping(value="/salesManagement/allPlannedPayments", method = RequestMethod.GET)
    public ModelAndView allPlannedPayments(){
        ModelAndView modelAndView = getModelAndViewWithAllPlannedPayments();

        modelAndView.setViewName("/salesManagement/allPlannedPayments");
        return modelAndView;
    }

    @RequestMapping(value="/salesManagement/allOverduePayments", method = RequestMethod.GET)
    public ModelAndView allOverduePayments(){
        ModelAndView modelAndView = getModelAndViewWithAllOverduePayments();
        modelAndView.setViewName("/salesManagement/allOverduePayments");
        return modelAndView;
    }

    @RequestMapping(value="/salesManagement/allPaymentsByTheEndOfThisWeek", method = RequestMethod.GET)
        public ModelAndView paymentsByTheEndOfThisWeek(){
        ModelAndView modelAndView = getModelAndViewWithAllPaymentsByTheEndOfThisWeek();
        modelAndView.setViewName("/salesManagement/allPaymentsByTheEndOfThisWeek");
        return modelAndView;
    }

    @RequestMapping(value="/salesManagement/allPaymentsByTheEndOfThisMonth", method = RequestMethod.GET)
    public ModelAndView paymentsByTheEndOfThisMonth(){
        ...
        modelAndView.setViewName("/salesManagement/allPaymentsByTheEndOfThisMonth");
        return modelAndView;
    }

    @RequestMapping(value="/salesManagement/allPaymentsByTheEndOfNextWeek", method = RequestMethod.GET)
    public ModelAndView paymentsByTheEndOfNextWeek(){
        ModelAndView modelAndView = getModelAndViewWithAllPaymentsByTheEndOfNextWeek();
        modelAndView.setViewName("/salesManagement/allPaymentsByTheEndOfNextWeek");
        return modelAndView;
    }

    @RequestMapping(value="/salesManagement/allPaymentsByTheEndOfNextMonth", method = RequestMethod.GET)
    public ModelAndView paymentsByTheEndOfNextMonth(){
        ...
        modelAndView.setViewName("/salesManagement/allPaymentsByTheEndOfNextMonth");
        return modelAndView;
    }

    @RequestMapping(value="/salesManagement/allInvoices", method = RequestMethod.GET)
    public ModelAndView allInvoices(){
        ...
        modelAndView.setViewName("/salesManagement/allInvoices");
        return modelAndView;
    }

    @RequestMapping(value="/salesManagement/paidInvoices", method = RequestMethod.GET)
    public ModelAndView paidInvoices(){
        ...
        modelAndView.setViewName("/salesManagement/paidInvoices");
        return modelAndView;
    }

    @RequestMapping(value="/salesManagement/unpaidInvoices", method = RequestMethod.GET)
    public ModelAndView unpaidInvoices(){
        ...
        modelAndView.setViewName("/salesManagement/unpaidInvoices");
        return modelAndView;
    }

    @RequestMapping(value="/salesManagement/openShipments", method = RequestMethod.GET)
    public ModelAndView openShipments(){
        ModelAndView modelAndView = getModelAndViewWithOpenShipments();
        modelAndView.setViewName("/salesManagement/openShipments");
        return modelAndView;
    }
...
//    }
    ...
    @RequestMapping(value="/salesManagement/fulfilledShipments", method = RequestMethod.GET)
    public ModelAndView fulfilledShipments(){
        ModelAndView modelAndView = getModelAndViewWithFulfilledShipments();
        modelAndView.setViewName("/salesManagement/fulfilledShipments");
        return modelAndView;
    }

    @RequestMapping(value="/salesManagement/thisWeekShipments", method = RequestMethod.GET)
    public ModelAndView thisWeekShipments(){
        ModelAndView modelAndView = getModelAndViewWithThisWeekShipments();
        modelAndView.setViewName("/salesManagement/thisWeekShipments");
        return modelAndView;
    }

    @RequestMapping(value="/salesManagement/thisMonthShipments", method = RequestMethod.GET)
    public ModelAndView thisMonthShipments(){
        ModelAndView modelAndView = getModelAndViewWithThisMonthShipments();
        modelAndView.setViewName("/salesManagement/thisMonthShipments");
        return modelAndView;
    }

    @RequestMapping(value="/salesManagement/nextWeekShipments", method = RequestMethod.GET)
    public ModelAndView nextWeekShipments(){
        ModelAndView modelAndView = getModelAndViewWithNextWeekShipments();
        modelAndView.setViewName("/salesManagement/nextWeekShipments");
        return modelAndView;
    }
    ...
    public ModelAndView nextMonthShipments(){
        ...
        modelAndView.setViewName("/salesManagement/nextMonthShipments");
        return modelAndView;
    }
